...
python3 carla_unreal_engine_5/test.py --model_onnx ~/Downloads/carla2cityscapes-360000.onnx --dataset_directory "$FOLDER_NAME/CarlaUE5-EPE" --out_path "$FOLDER_NAME/EnhancedPhotos"
