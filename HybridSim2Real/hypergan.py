...
input_dir = os.path.join(config["dataset_settings"]["dataset_path"], "ADDataset", "HybridSim2Real")
output_dir = os.path.join(config["dataset_settings"]["dataset_path"], "ADDataset", "HybridSim2Real")
checkpoint_path = "../code/checkpoints/HYPERGAN/" + config["HYPERGAN_settings"]["checkpoint_name"]
